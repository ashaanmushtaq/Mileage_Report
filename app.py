...
if current_file:
    try:
        ...
        if h_idx == -1:
            ...
            # ------------------------------------------------------------------
            # EXCEL REPORT BUILDER (DYNAMIC CITY HEADER)
            # ------------------------------------------------------------------
            ...
            # 1. Main Title Banner (Dynamic City Integration)
            ...
            # 2. Merged Centralized Metadata Block
            ...
            fill_repeat = PatternFill(start_color="FFCC80", end_color="FFCC80", fill_type="solid")
